...
En macOS, instala y abre Tailscale de forma interactiva, aprueba la solicitud del administrador e inicia sesión. Después, ejecuta `/pi-web restart`, seguido de `/remote`.
