...
ဤ repository သည် **pi-web ၏ local-model edition** ဖြစ်သည်။ ၎င်းသည် upstream pi-web အတွေ့အကြုံကို ထိန်းသိမ်းထားပြီး LAN တွင် host လုပ်ထားသော မော်ဒယ်များနှင့် ဒေသတွင်း deploy လုပ်ထားသော မော်ဒယ်များအတွက် သီးခြားထိန်းသိမ်းထားသော လမ်းကြောင်းတစ်ခုကို ထည့်သွင်းထားသည်။ Upstream ပြောင်းလဲမှုများကို ပုံမှန်အချိန်အတိုင်းအတာဖြင့် sync လုပ်ပြီး local-model ပြောင်းလဲမှုများကို ဤလိုင်းတွင် တွဲဖက်စမ်းသပ်ပြီး ထုတ်ပြန်သည်။
