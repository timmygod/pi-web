...
> **កំណែគំរូក្នុងស្រុក៖** ឃ្លាំងនេះគឺជាបម្រែបម្រួល pi-web ដែលបានថែរក្សាសម្រាប់គំរូភាសាដែល
> បានដាក់ពង្រាយក្នុងស្រុក និងបានផ្ទុកនៅលើ LAN។ គម្រោង pi-web ដើមនៅតែជាប្រភព upstream សម្រាប់
> មុខងារ និងការជួសជុលរួមគ្នា។ យើងធ្វើសមកាលកម្មការផ្លាស់ប្តូរ upstream ជាប្រចាំ ពិនិត្យពួកវាធៀបនឹង
> runtime គំរូក្នុងស្រុក និងបោះពុម្ពផ្សាយបន្ទាត់នេះដោយឯករាជ្យ ដើម្បីឱ្យការងារគំរូក្នុងស្រុកអាច
> ដំណើរការខ្លួនឯង។

ច្បាប់ថែរក្សា និងអភិវឌ្ឍន៍សម្រាប់កំណែនេះត្រូវបានកំណត់ឯកសារនៅក្នុង
[ការអភិវឌ្ឍន៍កំណែគំរូក្នុងស្រុក](docs/dev/local-llm-development.md)។
