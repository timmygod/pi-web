...
> **ဒေသဆိုင်ရာ မော်ဒယ်ထုတ်ဝေမှု:** ဤ repository သည် ဒေသတွင်းတွင် deploy လုပ်ထားပြီး LAN တွင်
> host လုပ်ထားသော ဘာသာစကားမော်ဒယ်များအတွက် ပြုစုထိန်းသိမ်းထားသော pi-web variant တစ်ခုဖြစ်သည်။
> မူလ pi-web project သည် မျှဝေထားသော feature များနှင့် ပြင်ဆင်မှုများအတွက် upstream source အဖြစ်
> ဆက်လက်တည်ရှိနေသည်။ ကျွန်ုပ်တို့သည် upstream ပြောင်းလဲမှုများကို ပုံမှန် sync လုပ်ပြီး၊ ဒေသဆိုင်ရာ
> မော်ဒယ် runtime နှင့် နှိုင်းယှဉ်၍ ပြန်လည်သုံးသပ်ကာ၊ ဒေသဆိုင်ရာ မော်ဒယ်အလုပ်များကို တစ်ပြိုင်နက်တည်း
> ဆောင်ရွက်နိုင်စေရန် ဤလိုင်းကို သီးခြားစီ ပြန်လည်ထုတ်ဝေပါသည်။

ဤထုတ်ဝေမှုအတွက် ပြုစုထိန်းသိမ်းရေးနှင့် ဖွံ့ဖြိုးတိုးတက်ရေး စည်းမျဉ်းများကို
[ဒေသဆိုင်ရာ မော်ဒယ်ထုတ်ဝေမှု ဖွံ့ဖြိုးတိုးတက်ရေး](docs/dev/local-llm-development.md) တွင် မှတ်တမ်းတင်ထားသည်။
