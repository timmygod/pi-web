...
> **รุ่นโมเดลท้องถิ่น:** ที่เก็บข้อมูลนี้เป็นเวอร์ชัน pi-web ที่ได้รับการดูแลสำหรับโมเดลภาษาที่ติดตั้ง
> ในเครื่องและโฮสต์บน LAN โครงการ pi-web เดิมยังคงเป็นแหล่งต้นน้ำสำหรับฟีเจอร์และการแก้ไขที่ใช้ร่วมกัน
> เราซิงค์การเปลี่ยนแปลงจากต้นน้ำเป็นระยะ ทบทวนเทียบกับรันไทม์ของโมเดลท้องถิ่น และเผยแพร่สายนี้
> แยกต่างหากเพื่อให้การทำงานกับโมเดลท้องถิ่นสามารถดำเนินไปพร้อมกันได้

กฎการบำรุงรักษาและการพัฒนาสำหรับรุ่นนี้ถูกบันทึกไว้ใน
[การพัฒนาเวอร์ชันโมเดลท้องถิ่น](docs/dev/local-llm-development.md)
