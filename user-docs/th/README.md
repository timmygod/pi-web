...
ที่เก็บข้อมูลนี้เป็น **เวอร์ชัน local-model ของ pi-web** โดยยังคงประสบการณ์ upstream ของ pi-web ไว้พร้อมเพิ่มเส้นทางที่ดูแลแยกต่างหากสำหรับโมเดลที่ติดตั้งในเครื่องและโฮสต์บน LAN การเปลี่ยนแปลง upstream จะถูกซิงค์เป็นระยะ ส่วนการเปลี่ยนแปลง local-model จะถูกทดสอบและเผยแพร่แบบขนานบนสายนี้
