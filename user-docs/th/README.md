...
## อะไรที่แตกต่างกันในเวอร์ชันนี้?

ที่เก็บข้อมูลนี้คงส่วนต่อประสาน pi-web และฟีเจอร์ที่ใช้ร่วมกันจาก upstream ไว้ แต่เปลี่ยนวิธีการปกป้องเซสชันเมื่อโมเดลที่เลือกทำงานในเครื่องหรือบน LAN ของคุณ

- **เลือกนโยบายรันไทม์ต่อเซสชัน** Auto ตรวจจับจุดปลายทางในเครื่อง/LAN เมื่อข้อมูลเมตาของผู้ให้บริการชัดเจน; Local และ Cloud เป็นการเขียนทับด้วยตนเองแบบถาวร
- **ป้องกันความล้มเหลวของบริบทตั้งแต่เนิ่นๆ** Local Mode จะบีบอัดที่การใช้งาน 65% และตรวจสอบอีกครั้งระหว่างการเรียกใช้เครื่องมือ ก่อนคำขอถัดไปจากผู้ให้บริการ
- **ทำให้สรุปมีขอบเขตจำกัด** จุดตรวจสอบแบบเลื่อนช่วยป้องกันไม่ให้สรุปเก่าเติบโตขึ้นเรื่อยๆ พยายามอีกครั้งด้วยงบประมาณที่เข้มงวดขึ้น และหยุดอย่างปลอดภัยเมื่อการบีบอัดไม่มีความคืบหน้าที่มีความหมาย
- **กู้คืนอย่างระมัดระวัง** การล้นของบริบท การหยุดชะงักของการส่งข้อมูลที่เลือก และการหยุดก่อนเวลาอันควรเฉพาะการให้เหตุผลสามารถดำเนินการต่อโดยอัตโนมัติ แต่การกำจัดเหตุการณ์ซ้ำซ้อนและตัวตัดวงจรที่ตระหนักถึงความคืบหน้าช่วยป้องกันลูปการกู้คืน
- **ให้ผู้ใช้เป็นผู้ควบคุม** Force Compact เป็นเส้นทางช่วยเหลือด้วยตนเองที่มองเห็นได้เสมอ ในขณะที่ Cloud Mode ยังคงเวิร์กโฟลว์และการควบคุมของ upstream ไว้

ผลลัพธ์ในทางปฏิบัตินั้นเรียบง่าย: งานโมเดลในเครื่องระยะยาวควรบีบอัดก่อนที่มันจะล้มเหลว กู้คืนหนึ่งครั้งเมื่อการกู้คืนปลอดภัย และหยุดอย่างสะอาดแทนที่จะวนซ้ำเมื่อไม่ปลอดภัย
...
| บันทึกการพัฒนา | [บันทึกการพัฒนา](../../docs/dev/local-llm-development.md) |
